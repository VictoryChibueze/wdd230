...
function displaySpotlights() {
  const members = [
    {
      name: "Company Name 1",
      description: "Company 1 is a leader in the tech industry.",
    ...
    {
      name: "Company Name 2",
      description: "Company 2 specializes in sustainable products.",
    ...
    {
      name: "Company Name 3",
      description: "Company 3 offers top-notch financial services.",
    ...
    {
      name: "Company Name 4",
      description: "Company 4 provides excellent healthcare services.",
      url: "https://www.company4.com",
      image: "images/company4.jpg",
      level: "gold",
    },
    {
      name: "Company Name 5",
      description: "Company 5 delivers fast and reliable logistics.",
      url: "https://www.company5.com",
  ...
  const spotlights = qualifiedMembers
